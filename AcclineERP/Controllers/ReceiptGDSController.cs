...
{
    public class ReceiptGDSController : Controller
    {
       private readonly IBranchAppService _BranchService;
        ...
        public ActionResult ReceiptRpt(string errMsg)
        {
        ...
        [HttpPost]
        public ActionResult ReceiptRptPdf(DateTime fDate, DateTime tDate, string ProjCode, string BranchCode, string FinYear)
        {
            ...
            if (!rUser.HasPermission("ReceiptGDSRpt_Preview"))
            {
           ...
           // string sql = string.Format("EXEC rpt_SP_Receipt_1 '" + fDate.ToString("yyyy/MM/dd") + "','" + tDate.ToString("yyyy/MM/dd") + "','" + ProjCode + "', '" + BranchCode + "', '" + FinYear + "','" + customerGroup + "'");
            ...
            return new Rotativa.ViewAsPdf("rptReceiptPdf", "", VchrLst)
            {
